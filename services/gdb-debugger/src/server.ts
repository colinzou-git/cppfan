...
import { DEBUG_LIMITS, validateStartPayload } from "./security.js";
import { SessionManager } from "./session-manager.js";
import type { ActionBody, StartBody, StopBody } from "./types.js";
...
export function startSessionReaper(intervalMs = 15_000): NodeJS.Timeout {
  return setInterval(() => {
    for (const id of sessions.expired(Date.now())) {
