...
const strongCppScores: RubricScore[] = [
  score("baseline_reasoning", 3),
  score("correctness", 4),
  score("cpp_implementation", 4),
  score("testing", 4),
  score("complexity", 4),
  score("communication", 3),
  score("hint_dependence", 4),
  score("follow_up_adaptability", 3)
];
...
export const RUBRIC_CALIBRATION_SAMPLES: CalibrationSample[] = [
  ...
  { id: "strong-cpp-success", label: "Strong C++ success", scores: strongCppScores, expectedReady: true },
