 ...
 * hard locks (see docs/SKILL_ENGINE.md). This component does not implement
 * FSRS, quizzes, reviews, or mastery scoring.
 */
export function SkillMapPreview({ data }: { data: SkillMapPreviewData }) {
