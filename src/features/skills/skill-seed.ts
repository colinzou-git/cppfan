...
export const skillSeed: Skill[] = [
  ...
  {
    id: "cpp.references.interface_intent",
    domain: "cpp",
    module_id: "cpp.references",
    title: "Function interface intent",
    description: "Read and design signatures that communicate input, output, in-out, ownership, and mutation intent.",
    learner_goal: "Choose return values, value/reference/view parameters, and non-owning pointers based on what a function promises to do.",
    level: "intermediate",
    item_types: ["lesson", "quiz", "bug_spotting"],
    order_index: 100,
    is_active: true
  ...
  {
    id: "cpp.references.optional_overloads",
    domain: "cpp",
    module_id: "cpp.references",
    title: "Optional results, overloads, and defaults",
    description: "Use std::optional for absence and design overload/default-argument sets without ambiguity.",
    learner_goal: "Return optional for maybe-values, use default arguments for simple defaults, and overload only for genuinely different input shapes.",
    level: "intermediate",
    item_types: ["lesson", "quiz"],
    order_index: 101,
    is_active: true
...
export const skillPrerequisitesSeed: SkillPrerequisite[] = [
  ...
  { skill_id: "cpp.references.interface_intent", prerequisite_skill_id: "cpp.references.parameter_passing", relationship_type: "recommended" },
  { skill_id: "cpp.references.interface_intent", prerequisite_skill_id: "cpp.references.views", relationship_type: "recommended" },
  { skill_id: "cpp.references.optional_overloads", prerequisite_skill_id: "cpp.references.interface_intent", relationship_type: "recommended" },
  ...
  { skill_id: "cpp.raii.ownership_boundary", prerequisite_skill_id: "cpp.references.non_owning", relationship_type: "recommended" },
  ...
  { skill_id: "cpp.smart_pointers.ownership_choice", prerequisite_skill_id: "cpp.references.interface_intent", relationship_type: "recommended" },
