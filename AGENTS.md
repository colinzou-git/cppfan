...
The app should be optimized for Windows PC, iPad, and iPhone. The long-term workflow should support GitHub-only development so the project can be continued from an iPhone through Codex, GitHub issues, pull requests, and CI feedback.
