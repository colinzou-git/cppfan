...
// Curriculum coverage (every active skill has content, dense skills have >=2
// items) is validated in tests/unit/skill-map-integrity.test.ts, derived from
// the active skill seed instead of a hand-maintained list (#97).
